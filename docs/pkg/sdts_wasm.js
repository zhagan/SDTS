...
const SdtsEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sdtsengine_free(ptr >>> 0, 1));
...
export class SdtsEngine {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        SdtsEngineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sdtsengine_free(ptr, 0);
    }
    /**
     * @param {string} scenario_json
     */
    constructor(scenario_json) {
        const ptr0 = passStringToWasm0(scenario_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sdtsengine_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        SdtsEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    set_scenario_file(scenario_file) {
        const ptr0 = passStringToWasm0(scenario_file, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.sdtsengine_set_scenario_file(this.__wbg_ptr, ptr0, len0);
    }
    start() {
        wasm.sdtsengine_start(this.__wbg_ptr);
    }
    stop() {
        wasm.sdtsengine_stop(this.__wbg_ptr);
    }
    /**
     * @param {number} elapsed_seconds
     */
    update(elapsed_seconds) {
        wasm.sdtsengine_update(this.__wbg_ptr, elapsed_seconds);
    }
    /**
     ...
     * @returns {string}
     */
    impact(elapsed_seconds, x_mm, y_mm) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.sdtsengine_impact(this.__wbg_ptr, elapsed_seconds, x_mm, y_mm);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    snapshot_json() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.sdtsengine_snapshot_json(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    export_recording() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.sdtsengine_export_recording(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    load_recording(recording_json) {
        const ptr0 = passStringToWasm0(recording_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sdtsengine_load_recording(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
     ...
     */
    start_replay() {
        const ret = wasm.sdtsengine_start_replay(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @returns {string}
     */
    replay_update(elapsed_seconds) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.sdtsengine_replay_update(this.__wbg_ptr, elapsed_seconds);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sdts_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
